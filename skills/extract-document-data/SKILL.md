...
description: Extract structured, grounded fields from documents (payslips, invoices, bank statements, contracts, forms) — values are what the document shows, and missing values abstain instead of being hallucinated. Use when the user asks to pull fields out of a document, convert a document to structured data, or parse invoices/payslips/statements.
---
